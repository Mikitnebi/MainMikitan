...
{
    /// <inheritdoc />
    public partial class defDataAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -1, new DateTime(2023, 12, 10, 3, 43, 38, 585, DateTimeKind.Local).AddTicks(1287), "customer@gmail.com", true, "Customer", "AQAAAAIAAYagAAAAEGLqrr2w4qvXqiMeK1lqTuXCmWxAPjMEFLI/N65/6v4WfCINkMUI5uJY2ekTCyHwPg==", "000000000", true, 0 });

            migrationBuilder.InsertData(
                table: "Restaurant",
                columns: new[] { "Id", "CreatedAt", "PasswordHash", "UpdatedAt", "UserName" },
                values: new object[] { -1, new DateTime(2023, 12, 10, 3, 43, 38, 643, DateTimeKind.Local).AddTicks(670), "AQAAAAIAAYagAAAAECsdiAjDWYFgehiRnIGNjHWSHddPjbYVA740Og5X/hySZ2sFMcdRdfP7uK2W+TxVxA==", null, "restaurant" });
